...
//        });
    ...
    {
        PopupMenu popupMenu = new PopupMenu(Timepass.this,v);
...
//                    Toast.makeText(Timepass.this,"profile",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Timepass.this,profile.class);
                ...
                if(item.getItemId()==R.id.logout)
                {
                    ...
                    GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                            ...
                            .requestEmail()
                            .build();
                    GoogleSignInClient mGoogleSignInClient = GoogleSignIn.getClient(Timepass.this, gso);
                    mGoogleSignInClient.signOut();
                    mGoogleSignInClient.revokeAccess();
                    startActivity(new Intent(Timepass.this, LoginActivity.class));
                    finish();
